...
//    private final static String successIconXpathLocator = "//i[@class='icon-ok'] локатор";
...
//        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath "локатор в этом случае или константу"));
